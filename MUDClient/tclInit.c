...
void Command_Init(Tcl_Interp *interp) {
    ...
    Tcl_CreateCommand(interp, "sendString", (Tcl_CmdProc *) sendStringCmd, (ClientData) NULL,
                      (Tcl_CmdDeleteProc *) NULL);
    /* Binds the Tcl command receiveString to the C command receiveStringCmd */
    Tcl_CreateCommand(interp, "receiveString", (Tcl_CmdProc *) receiveStringCmd, (ClientData) NULL,
                      (Tcl_CmdDeleteProc *) NULL);
    ...
    Tcl_CreateCommand(interp, "sendReceiveString", (Tcl_CmdProc *) processStringCmd, (ClientData) NULL,
                      (Tcl_CmdDeleteProc *) NULL);
}
